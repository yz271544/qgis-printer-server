 ...
 */
QgsAbstract3DRenderer* StyleCircle::get3dSymbolRenderer(const QColor &color, double opacity, float altitude) {
...
QgsRuleBased3DRenderer *StyleCircle::get3dRuleRenderer(
    ...
    for (int i = 0; i < colors.size(); ++i) {
        ...
        symbol->setOffset(Formula::getRelativeAltitude(altitudes[i]));
